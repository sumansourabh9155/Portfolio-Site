...
const Navbar = () => {
    ...
    return (<div>
        ...
        <div className="flex items-center justify-between h-24 max-w-[1240p] mx-auto p-4 text-white" >
            ...
            <div className={!showMenu ? "fixed left-0 top-0 w-[60%] h-full border-r-grey-900 pt-8  border-b-2 bg-gray-800 ease-in-out duration-500" : "fixed left-[-100%]"}>
